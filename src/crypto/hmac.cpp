...
std::string base64_encode_impl(std::span<const std::uint8_t> data,
...
Result<std::vector<std::uint8_t>> base64_decode_impl(std::string_view encoded,
                                                     bool url_safe) {
  // Build decode table
...
Result<std::string> generate_l2_signature(std::string_view api_secret,
