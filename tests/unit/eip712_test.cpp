...
TEST_CASE("ClobAuth struct hashing", "[crypto][eip712]") {
	SECTION("Struct hash") {
		ClobAuth auth{.address = Address::from_hex("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"),
	...
	SECTION("Different timestamps produce different hashes") {
		ClobAuth auth1{.address = Address::from_hex("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"),
					   .timestamp = "1234567890",
					   .nonce = 0,
					   .message = "This message attests that I control the given wallet"};
...
TEST_CASE("Order struct hashing", "[crypto][eip712]") {
	SECTION("Basic order hash") {
		Order order{
			...
			.maker = Address::from_hex("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"),
			.signer = Address::from_hex("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"),
