...
TEST_CASE("Address from public key", "[crypto][keccak]") {
    ...
    // Public key (uncompressed, without 04 prefix) that corresponds to a known address
...
TEST_CASE("EIP-55 checksum addresses", "[crypto][keccak]") {
    SECTION("All lowercase") {
        Address addr = Address::from_hex("0x5aaeb6053f3e94c9b9a09f33669435e7ef1beaed");
...
TEST_CASE("secp256k1 signing", "[crypto][secp256k1]") {
    ...
    std::string_view test_key = "0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80";
    ...
    SECTION("Derive address") {
        ...
        REQUIRE(addr->to_checksum() == "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266");
    }
