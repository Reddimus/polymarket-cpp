...
public:
	...
	[[nodiscard]] static Result<Ed25519PrivateKey>
	from_seed(std::span<const std::uint8_t, 32> seed);
...
[[nodiscard]] Result<bool> ed25519_verify(std::span<const std::uint8_t> message,
