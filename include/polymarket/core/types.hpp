...
struct uint256_t {
    ...
    /// Alias for from_u64
    static uint256_t from_uint64(std::uint64_t value) {
...
public:
    ...
    static Decimal from_double(double d) {
        return Decimal(static_cast<std::int64_t>(d * SCALE));
    }
