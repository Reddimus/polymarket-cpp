...
///
/// This module provides a comprehensive error system using C++23's std::expected
/// for zero-overhead error handling without exceptions.
...
[[nodiscard]] constexpr std::string_view to_string(ErrorCode code) noexcept {
    switch (code) {
        ...
        case ErrorCode::RateLimitError:  return "RateLimitError";
        ...
        case ErrorCode::NotFoundError:   return "NotFoundError";
        case ErrorCode::BadRequestError: return "BadRequestError";
...
public:
    ...
    [[nodiscard]] static Error from_http_status(int status, std::string msg) {
        ErrorCode code;
        switch (status) {
            case 400: code = ErrorCode::BadRequestError; break;
            case 401:
            case 403: code = ErrorCode::AuthError; break;
            case 404: code = ErrorCode::NotFoundError; break;
            case 429: code = ErrorCode::RateLimitError; break;
            default:
                if (status >= 500) {
