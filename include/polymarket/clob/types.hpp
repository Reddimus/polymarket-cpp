...
[[nodiscard]] inline Decimal to_decimal(TickSize tick) {
	switch (tick) {
		case TickSize::Tenth:
			return Decimal::from_double(0.1);
		case TickSize::Hundredth:
			return Decimal::from_double(0.01);
		case TickSize::Thousandth:
			return Decimal::from_double(0.001);
		case TickSize::TenThousandth:
			return Decimal::from_double(0.0001);
	}
	return Decimal::from_double(0.01);
}
